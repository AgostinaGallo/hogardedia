...
@section('content')
    @include('users.partials.header', [
        ...
        'description' => __('Esta es la página de tu perfil. Podes ver tus datos y actualizarlos si es necesario'),
        'class' => 'col-lg-7'
    ])   
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-3 order-lg-2">
                            <div class="card-profile-image">
                                <a href="#">
                                    <img src="{{ asset('argon') }}/img/theme/user-sonrisa.png" class="rounded-circle">
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <form method="post" action="{{ route('profile.password') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group">
                                    <label class="form-control-label" for="input-password-confirmation">{{ __('Repetir Contraseña Nueva') }}</label>
