...
<!--FORMULARIO CHEVERE -->
    ...
    <div class="colcol-xl-6 col-lg-6">
      <div class="card-body" >          
        <form>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
                  <div class="form-group">                  
                    ...
                    <h5 class="mb-0">Fecha Nacimiento</h5>
                  </div>
                </div>
            </div>            
                ...
                <label class="control-label">Genero:</label>
                    <div class="controls">
                      ...
                      <div class="custom-control custom-control-alternative custom-checkbox mb-3">
                        ...
                        <label class="custom-control-label" for="customCheck5">Masculino</label>
                      </div>

                      <div class="custom-control custom-control-alternative custom-checkbox mb-3">
                        <input class="custom-control-input" id="customCheck5" type="checkbox">
                        <label class="custom-control-label" for="customCheck5">Femenino</label>
                      </div>

                      <div class="custom-control custom-control-alternative custom-checkbox mb-3">
                        <input class="custom-control-input" id="customCheck5" type="checkbox">
                        <label class="custom-control-label" for="customCheck5">Otro</label>
                      </div>
